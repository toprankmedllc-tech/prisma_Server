    ...
    private mapToDetailDto(question: any): QuestionDetailDto {
        return {
            ...
            aiReviews: question.aiReviews?.map((ar: any) => ({
                ...
                humanComment: ar.humanComment,
                humanAgree: ar.humanAgree,
                humanReviewedBy: ar.humanReviewedBy,
                humanReviewedAt: ar.humanReviewedAt,
                verificationVerdict: ar.verificationVerdict,
                verificationAgrees: ar.verificationAgrees,
                verificationConfidence: ar.verificationConfidence,
                verificationReason: ar.verificationReason,
